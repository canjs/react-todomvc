...
import { connect, ObserveObject, observer } from "ylem";
...
const List = observer(({todos, isEditing, edit, updateName, cancelEdit, editing, length}) => {
    return (
    <ul id="todo-list">
...
export default connect(Store)(List);